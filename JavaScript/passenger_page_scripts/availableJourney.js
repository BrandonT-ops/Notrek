function showAvailableJourneys(){
    ...
    console.log("available journeys clicked");
  
    document.getElementById("availableJourneyList").innerHTML = "";
    document.getElementById("requestJourneyForm").style.display = "none";
    document.getElementById("availableJourneyList").style.display = "block";
    ...
    console.log("finished executing show Available journeys");
    //if (sessionStorage.getItem("isLogin")) {
      console.log("finished executing show Available journeys");    
          ...
          if (this.readyState == 4 && this.status == 200) {
            ...
            if(myJourneys.length > 0){
                for(let i=0;i<myJourneys.length;i++){
                  ...
                  document.getElementById("availableJourneyList").appendChild(div);
        ...
        xmlhttpAvailable.open("GET","../php/get_available_journey.php?sender=passenger",true);
